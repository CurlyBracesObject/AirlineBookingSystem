...
<body>
<div class="x-body">
    <form class="layui-form" method="POST" id="deptForm" action="${ctx}/feiji/update/entity">
        ...
        <div class="layui-form-item">
            <label for="chu_fa_di" class="layui-form-label">
                <span class="x-red">*</span>Departure
            </label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label for="zuo_wei_total" class="layui-form-label">
                <span class="x-red">*</span>Total number of seats
            </label>
            <div class="layui-input-inline">
