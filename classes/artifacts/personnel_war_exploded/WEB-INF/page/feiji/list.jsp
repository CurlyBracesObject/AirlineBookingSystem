...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/feiji/list"
       title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${ctx }/feiji/list">
...
<!--        <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button> -->
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <th>Whether passed the approve</th>
            <td>operation</td>
        </thead>
        <tbody>
                ...
                <td class="td-manage">
                    <c:if test="${hasRole}">
                        <c:if test="${item.status eq 'UN_PASS'}">
                            <a title="pass" href="${ctx}/feiji/pass?id=${item.id}">
