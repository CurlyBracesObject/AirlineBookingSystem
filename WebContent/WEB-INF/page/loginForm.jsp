...
<head>
	<meta charset="UTF-8">
	<title>Backstage login-Enterprise OA office system</title>
...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        <div class="message">Air ticket reservation management system</div>
        ...
        <form method="post" class="layui-form" action="${ctx}/login">
            ...
            <option value="1">Airline Admin</option>
            <option value="3">Airline Manager</option>
