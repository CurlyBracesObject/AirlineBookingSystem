...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="./index.html">Air ticket booking backend</a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a onclick="x_admin_show('个人信息','${ctx }/user/myupdate')">Personal information</a></dd>
      ...
      <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${ctx }/feiji/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>airplane information edit</cite>

                        </a>
                    </li >
                    <li>
                        <a _href="${ctx }/feijizuowei/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>airplane seat information edit</cite>
                        </a>
                    </li>
