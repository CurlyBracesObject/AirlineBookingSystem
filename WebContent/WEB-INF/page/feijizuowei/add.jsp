...
<body>
<div class="x-body">
    <form class="layui-form" method="POST" id="deptForm" action="${ctx}/feijizuowei/save/entity">
            ...
            <div class="layui-input-inline">
                <select class="layui-input" name="fei_ji_id" id="fei_ji_id">
                    <c:forEach items="${feijiList}" var="item" varStatus="stat">
                        <option value="${item.id}">${item.fei_ji_name}</option>
                    </c:forEach>
                </select>
            </div>
        ...
        <div class="layui-form-item">
            <label for="type" class="layui-form-label">
                <span class="x-red">*</span>seats type
            </label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label for="price" class="layui-form-label">
                <span class="x-red">*</span>seat price
            <div class="layui-input-inline">
