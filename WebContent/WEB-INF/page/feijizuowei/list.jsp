...
<div class="x-nav">
    ...
    <button type="button" onclick="location.href='${ctx}/feijizuowei/add'" class="layui-btn layui-btn-small"
            style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"><i class="layui-icon"></i>Add
    </button>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/feijizuowei/list"
       title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${ctx }/feijizuowei/list">
        ...
        <c:forEach items="${feiJiZuoWeiList}" var="item" varStatus="stat">
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a title="edit" href="${ctx}/feijizuowei/toUpdate?id=${item.id}">
...
<script>
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            //发异步删除数据
            //等以后再使用异步，这里先使用
            $.post("${ctx}/feijizuowei/delete?id=" + id);
